# I follow the w10 under path2nn to install it via conda now
# test it via the tf-test.py some issues but still can calculate
...
X_train = np.load("tf-X_train.npy")
y_train = np.load("tf-y_train.npy")
